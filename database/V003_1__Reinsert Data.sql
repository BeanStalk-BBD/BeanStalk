...
(@AliceBobChatID, 'WASSUP', '2024-03-07 12:00:00', @AliceID), -- Alice to Bob
(@AliceBobChatID, N'🫛🔗🎊', '2024-03-07 12:01:00', @BobID), -- Bob to Alice
(@AliceBobChatID, N'🗿🗿🗿', '2024-03-07 12:05:00', @AliceID), -- Alice to Bob
(@AliceBobChatID, N'🗿🗿🗿', '2024-03-07 12:06:00', @BobID), -- Bob to Alice
 (@AliceBobChatID, 'FOO', '2024-03-08 19:00:00', @AliceID), -- Alice to Bob
(@AliceBobChatID, '232', '2024-03-08 19:01:00', @BobID), -- Bob to Alice
(@AliceBobChatID, N'👋🍗', '2024-03-08 19:02:00', @AliceID), -- Alice to Bob
(@AliceBobChatID, N'😊😋', '2024-03-08 19:03:00', @BobID), -- Bob to Alice
(@AliceBobChatID, 'UwU', '2024-03-08 12:00:00', @AliceID), -- Alice to Bob
(@AliceBobChatID, N'LIKE🫛🔗🎊', '2024-03-08 12:01:00', @BobID), -- Bob to Alice
(@AliceBobChatID, N'🗿🗿🗿', '2024-03-08 12:05:00', @AliceID), -- Alice to Bob
(@AliceBobChatID, N'(\/);,,,;(\/)', '2024-03-08 12:06:00', @BobID), -- Bob to Alice
